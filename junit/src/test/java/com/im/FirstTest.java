...
public class FirstTest {
    ...
    void shouldReturnNewStringWhenSubstringFound() {
        //given
        String mainString = "this is apoorva garg";
        String findstring = "garg";
        String replacedString = "kittu";
        String expectedString = "this is apoorva kittu";
    ...
    void shouldReturnOriginalStringWhenSubstringNotFound() {
        //given
        String mainString = "this is apoorva garg";
        String findstring = "kittu";
        String replacedString = "ttn";
        String expectedString = "this is apoorva garg";
