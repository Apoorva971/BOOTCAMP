...
public class ProductVariationController {
    ...
    public ReturnJson addProductVariation(@RequestBody ProductVariationDto productVariationDto, @ApiIgnore Locale locale) {
    ...
    public ReturnJson updateNewProductVariation(@RequestParam("productVariationId") Long productVariationId,
                                                @RequestBody ProductVariationDto productVariationDto, @ApiIgnore Locale locale)
            throws IOException {
    ...
    public List<Product> similarProductVariation(@PathVariable Long productId, @RequestParam(required = false) PagingAndSortingDto pagingAndSortingDto, @ApiIgnore Locale locale) {
